    ...
    <>
      <div className=" bg-gradient-to-t from-[#1877F2] to-[#0B5FCC] mt-8 h-[90vh] w-[100%]">
        ...
        <div className=" flex justify-center mt-5">
          <div className="w-[80%] text-center flex justify-center items-center "></div>
        </div>
            ...
            <div className="stats shadow">
              <div className="card w-96 shadow-2xl ">
                <div className="card-body ">
                  <h1 className="stat-value text-[28px]">
...
<strong><i>{items.marks}</i></strong>
        ...
        <div className="w-[100%] h-[250px] flex justify-center pt-4 gap-4 mb[-5] bg-gradient-to-t from-[#1877f2] to-[#1877f9]">
          <button className="btn btn-wide  bg-gradient-to-br from-yellow-200 via-yellow-300 to-yellow-400 text-black hover:bg-gradient-to-br focus:outline-none focus:ring-white dark:focus:ring-black shadow-lg font-medium rounded-lg text-sm px-5 py-[4px] text-center mr-2 mb-2">
            <Link href={`/playlist/${params.result}`}>Restart Course</Link>
          </button>
          <button
            className="btn-wide btn bg-gradient-to-br from-yellow-200 via-yellow-300 to-yellow-400 text-black  hover:bg-gradient-to-br  focus:ring-white focus:ring-2   dark:focus:ring-[#ffffff]  shadow-lg font-medium rounded-lg "
            disabled={false}
          >
            Get Certificate
          </button>
