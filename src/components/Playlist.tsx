...
{/* #fed32e */}
      ...
      <div className="max-w-[450px] flex flex-col h-[600px] gap-10 text-lg border rounded-lg overflow-auto scrollbar-thin scrollbar-thumb-[#6c00a5] scrollbar-track-[#fed32e] bg-gradient-to-r from-[#eeeeee] to-[#e9e5e5]">
      ...
      <h1 className="text-lg font-extrabold text-gray-900 -pt-[30px] dark:text-black md:text-5xl lg:text-4xl text-center"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 ">{props}</span>&nbsp;<span className="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Course</span></h1> 
